...
<head>
  ...
  <script src="<?php ROUTE ?>mujer.js"></script>
  ...
  <div class="wrap">
    ...
    <div class="store-mujer">
      <div class="category">
        ...
        <a href="#store-mujer" class="category-items" category-all="blusas">Blusas</a>
        ...
        <a href="#store-mujer" class="category-items" category-all="Faldas">Faldas</a>
        <a href="#store-mujer" class="category-items" category-all="zapatos">Zapatos</a>
      </div>
      <section class="lista">
        <div class="products_item" category-all="blusas">
          <img src="<?php ROUTE ?>imagen2\blusa.jpg" alt="" />
          <a href="#">Blusa floreada</a>
        </div>
        <div class="products_item" category-all="blusas">
          <img src="<?php ROUTE ?>imagen2\camis.jpg" alt="" />
          <a href="#">Blusa rayas </a>
        </div>
        <div class="products_item" category-all="pantalones">
          <img src="<?php ROUTE ?>imagen2\jeansM.jpg" alt="" />
          <a href="#">jeans-Mujer</a>
        </div>
        <div class="products_item" category-all="pantalones">
          <img src="<?php ROUTE ?>imagen2\jeansMC.jpg" alt="" />
          <a href="#">Jeans-color</a>
        </div>
        <div class="products_item" category-all="Faldas">
          <img src="<?php ROUTE ?>imagen2\falda.jpg" alt="" />
          <a href="#">Falda-azul</a>
        </div>
        <div class="products_item" category-all="Faldas">
          <img src="<?php ROUTE ?>imagen2\faldarosa.jpg" alt="" />
          <a href="#">Falda-Rosa</a>
        </div>
        <div class="products_item" category-all="Faldas">
          <img src="<?php ROUTE ?>imagen2\faldavino.jpg" alt="" />
          <a href="#">Falda-Vino</a>
        </div>
        <div class="products_item" category-all="chaquetas">
          <img src="<?php ROUTE ?>imagen2\chaquetaC.jpg" alt="" />
          <a href="#">Chaqueta-cuero</a>
        </div>
        <div class="products_item" category-all="chaquetas">
          <img src="<?php ROUTE ?>imagen2\chaquetaMC.jpg" alt="" />
          <a href="#">Chaqueta-color</a>
        </div>
        <div class="products_item" category-all="zapatos">
          <img src="<?php ROUTE ?>imagen2\zapatosD.jpg" alt="" />
          <a href="#">zapatos-deportivos</a>
        </div>
        <div class="products_item" category-all="zapatos">
          <img src="<?php ROUTE ?>imagen2\zapatosM.jpg" alt="" />
          <a href="#">zapatos</a>
        </div>
      </section>
    </div>
