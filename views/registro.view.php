...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="http://localhost/CursoPHP/Online_tienda/css2/registro.css" />
  ...
  <body>
    <a name="registro"></a>
    <form action="" id="form1" method="GET" class="formulario">
      ...
      <label for="" class="formulario-label"
        >Vuelve a repetir la contraseña:</label
      >
      <input type="password" name="password" class="form-control" required />
    ...
    <script src="http://localhost/CursoPHP/Online_tienda/js/form.js"></script>
  </body>
</html>
