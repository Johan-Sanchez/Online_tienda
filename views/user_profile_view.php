...
<div class="wrap">
    <h1>Configuracion de cuenta general</h1>
    ...
    <form id="btn-cointainer" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <div class="products_item_detail_right">
                ...
                <div class="inner_right">
                    <ul>
                        ...
                        <li class="info-section">
                            ...
                            <span class="edit-btn"><i class="fas fa-edit"></i>Editar</span>
                        </li>
                        <li class="info-section">
                ...
                <div class="inner_right">
                    ...
                    <ul>
                        ...
                        <li>
                            <button id="cancel-plan-btn" class="stripe-btn" style="font-size: 1rem">Cancelar</button>                        
                        </li>
                    </ul>
        ...
        <button class="stripe-btn" style="margin: auto">Guardar</button>
        <input type="text" id="subscription-status" name="subscription-status">
    </form>
